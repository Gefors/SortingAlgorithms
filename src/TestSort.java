public class TestSort {
    ...
    public static void main(String[] args) {
        ...
        IntSorter quickSort = new QuickSort();
        IntSorter modifiedMergeSort = new ModifiedMergeSort();
        IntSorter modifiedQuickSort = new ModifiedQuickSort();
        IntSorter treeMapSort = new TreeMapSort();
        
        int firstN = 20000;

        System.out.println("Unordered:");
        testSort(mergeSort, firstN, false);
        System.out.println("\nOrdered:");
        testSort(mergeSort, firstN, true);

        System.out.println("\n"+mergeSort.getClass().getName()+".sort tested ok!");
        System.exit(0);
    }
}
